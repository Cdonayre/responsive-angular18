...
//Renamed from availableSystems
  ...
  addOrEdit(): void {
    ...
    if (this.isEditMode) {
      ...
      console.log('--- Debugging POST Payload (FormUsuarioComponent) ---');
      console.log('rawFormData from getRawValue():', rawFormData);
      console.log('Value of sistema_id form control:', this.userForm.get('sistema_id')?.value);
      console.log('Final formDataForCreate object being sent:', formDataForCreate);
      console.log('----------------------------------------------------');
